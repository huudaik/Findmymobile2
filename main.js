...
var api = new ParseServer({
  databaseURI: databaseUri || 'mongodb://admin:kzhrYDXpN0r3c6SrqwAueYJb@mongodb7.back4app.com:27017/276a56b6064f43059963de43f3d5f7da?ssl=true',
  cloud: process.env.CLOUD_CODE_MAIN || __dirname + '/cloud/main.js',
  appId: process.env.APP_ID || '7f5DGPsa4DGKJA4RFvV2Hj0rxbPzXEB24p0IRNDi',
  masterKey: process.env.MASTER_KEY || 'C66HPQfef7oA6WOuyJh5TSGtgcH1vbuiSS67tlCH', //Add your master key here. Keep it secret!
  serverURL: process.env.SERVER_URL || 'https://parseapi.back4app.com/',  // Don't forget to change to https if needed
  liveQuery: {
...
Parse.initialize("7f5DGPsa4DGKJA4RFvV2Hj0rxbPzXEB24p0IRNDi", "2DxvFIRd3gEs4k8yA136M4606YMOn9FKmFkoeGDy"); //PASTE HERE YOUR Back4App APPLICATION ID AND YOUR JavaScript KEY
				...
				if(notificationLeft > 0){
		  			...
		  			Parse.Push.send({where: query, // Set our Installation query
							data: {					  
								...
								objectType:"android",
								action:"com.mango.library.findmyphone.MESSAGE"
							}
						},{success: function() {
							// Push was successful
